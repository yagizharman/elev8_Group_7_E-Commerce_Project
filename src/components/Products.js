    ...
    <div className="py-10">
      <div className="flex flex-col items-center gap-4">
        ...
        <p className="max-w-[700px] text-gray-600 text-center">
          Store is a huge online market place where individuals can buy, sell,
          trade, and collect one-of-a-kind products. Additionally, as a
          community, we work to promote improvements for people, the
